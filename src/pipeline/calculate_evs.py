...
def calculate2LegBets(data, bookmakers, engine, current_date, 
    ...
    """
    Simplified 2-leg parlay finder using FeatureEngine.
    Returns player names, lines, and predictions only.
    """
    ...
    # Store predictions and metadata for each player
    player_predictions = {}
    player_teams = {}
    player_opponents = {}
    player_lines = {}
    ...
    for player in available_players:
        ...
        # Use engine.project_player() to get prediction
        try:
    ...
    # Convert to DataFrame and sort by combined edge
...
def calculate3LegBets(data, bookmakers, engine, current_date, 
                             ...
                             teamStarPlayer=None, league_df=None, findOpp=None):
    """
    Simplified 3-leg parlay finder using FeatureEngine.
    Returns player names, lines, and predictions only.
    """
    ...
    for player1, player2, player3 in valid_combinations:
        ...
        # Determine side (over/under) and calculate proper edge
        if prediction1 > line1:
            side1 = 'over'
            edge1 = prediction1 - line1
        else:
