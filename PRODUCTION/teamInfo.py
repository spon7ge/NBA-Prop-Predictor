projectedStartingFive = {
    ...
    "CHA": ["LaMelo Ball", "Miles Bridges", "Sion James", "Kon Knueppel", "Ryan Kalkbrenner"],
    "CHI": ["Matas Buzelis", "Coby White", "Josh Giddey", "Isaac Okoro", "Nikola Vucevic"],
    "CLE": ["De'Andre Hunter", "Evan Mobley", "Jarrett Allen", "Donovan Mitchell"],
    ...
    "IND": ["Pascal Siakam", "Andrew Nembhard", "Tyrese Haliburton", "Jarace Walker", "Bennedict Mathurin"],
    ...
    "MIA": ["Andrew Wiggins", "Norman Powell", "Pelle Larsson", "Davion Mitchell"],
    "MIL": ["AJ Green", "Kyle Kuzma", "Ryan Rollins", "Myles Turner", "Giannis Antetokounmpo"],
    "MIN": ["Rudy Gobert", "Donte DiVincenzo", "Jaylen Clark", "Anthony Edwards", "Julius Randle"],
    "NOP": ["Derik Queen", "Jeremiah Fears", "Herbert Jones", "Trey Murphy"],
    "NYK": ["Mikal Bridges", "Landry Shamet", "Karl-Anthony Towns", "Mitchell Robinson"],
    "OKC": ["Chet Holmgren", "Luguentz Dort", "Cason Wallace", "Thomas Sorber", "Shai Gilgeous-Alexander"],
    "ORL": ["Paolo Banchero", "Wendell Carter", "Jalen Suggs", "Franz Wagner", "Tristan da Silva"],
    "PHI": ["Justin Edwards", "Dominick Barlow", "Tyrese Maxey", "VJ Edgecombe", "Andre Drummond"],
    "PHX": ["Mark Williams", "Devin Booker", "Dillon Brooks", "Ryan Dunn", "Royce O'Neale"],
    "POR": ["Shaedon Sharpe", "Donovan Clingan", "Damian Lillard", "Deni Avdija", "Toumani Camara"],
    "SAC": ["DeMar DeRozan", "Keon Ellis", "Drew Eubanks", "Zach LaVine", "Russell Westbrook"],
    "SAS": ["Jordan McLaughlin", "Devin Vassell", "De'Aaron Fox", "Luke Kornet", "Harrison Barnes"],
    "TOR": ["Brandon Ingram", "Jakob Poeltl", "Immanuel Quickley", "RJ Barrett", "Scottie Barnes"],
    "UTA": ["Keyonte George", "Svi Mykhailiuk", "Walker Kessler", "Lauri Markkanen", "Ace Bailey"],
    "WAS": ["Khris Middleton", "CJ McCollum", "Bilal Coulibaly", "Kyshawn George"],
}
