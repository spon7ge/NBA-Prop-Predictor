projectedStartingFive = {
    ...
    "CLE": ["Dean Wade", "James Harden", "Donovan Mitchell", "Evan Mobley", "Jarrett Allen"],
    ...
    "OKC": ["Luguentz Dort", "Chet Holmgren", "Isaiah Hartenstein", "Shai Gilgeous-Alexander", "Ajay Mitchell"],
