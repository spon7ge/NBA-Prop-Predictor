projectedStartingFive = {
    ...
    "DAL": ["Daniel Gafford", "Max Christie", "Dereck Lively", "P.J. Washington", "Brandon Williams"],
    "DEN": ["Jamal Murray", "Peyton Watson", "Nikola Jokić", "Cameron Johnson"],
    "DET": ["Cade Cunningham", "Tobias Harris", "Jalen Duren", "Caris LeVert", "Duncan Robinson"],
    "GSW": ["Will Richard", "Moses Moody", "Brandin Podziemski", "Buddy Hield", "Quinten Post"],
