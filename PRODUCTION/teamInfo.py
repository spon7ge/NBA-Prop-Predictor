projectedStartingFive = {
    "ATL": ["Jalen Johnson", "Dyson Daniels", "Onyeka Okongwu", "Vit Krejci", "Nickeil Alexander-Walker"],
    ...
    "DET": ["Isaiah Stewart", "Cade Cunningham", "Jalen Duren", "Daniss Jenkins", "Duncan Robinson"],
