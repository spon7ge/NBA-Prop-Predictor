projectedStartingFive = {
    ...
    "DAL": ["P.J. Washington", "Cooper Flagg", "Brandon Williams", "Max Christie", "Moussa Cisse"],
    "DEN": ["Tim Hardaway", "Jamal Murray", "Nikola Jokic", "Aaron Gordon"],
    "DET": ["Isaiah Stewart", "Duncan Robinson", "Jalen Duren", "Ronald Holland", "Daniss Jenkins"],
