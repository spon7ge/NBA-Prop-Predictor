projectedStartingFive = {
    ...
    "MIN": ["Terrence Shannon", "Rudy Gobert", "Julius Randle", "Jaden McDaniels", "Mike Conley"],
    ...
    "SAS": ["De'Aaron Fox", "Julian Champagnie", "Devin Vassell", "Stephon Castle", "Victor Wembanyama"],
