projectedStartingFive = {
    ...
    "DET": ["Tobias Harris", "Cade Cunningham", "Ausar Thompson", "Duncan Robinson", "Jalen Duren"],
    ...
    "ORL": ["Wendell Carter", "Paolo Banchero", "Jamal Cain", "Jalen Suggs", "Desmond Bane"],
    ...
    "TOR": ["RJ Barrett", "Jamal Shead", "Scottie Barnes", "Jakob Poeltl", "Ja'Kobe Walter"],
