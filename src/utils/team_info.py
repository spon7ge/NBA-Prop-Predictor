projectedStartingFive = {
    ...
    "CHI": ["Isaac Okoro", "Matas Buzelis", "Nikola Vučević", "Josh Giddey", "Coby White"],
    "CLE": ["Dean Wade", "Jarrett Allen", "De'Andre Hunter", "Donovan Mitchell", "Darius Garland"],
    ...
    "MIN": ["Julius Randle", "Rudy Gobert", "Jaden McDaniels", "Bones Hyland", "Donte DiVincenzo"],
