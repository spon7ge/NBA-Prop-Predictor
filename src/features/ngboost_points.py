...
def build_ngboost_points_features(
    ...
    features['PTS_OFF_TOV_L5_OVER_BASELINE'] = safe_delta(player_df['PTS_OFF_TOV'].tail(5), pts_off_tov_avg) if 'PTS_OFF_TOV' in player_df.columns else 0.0
    features['PTS_OFF_TOV_L10_OVER_BASELINE'] = safe_delta(player_df['PTS_OFF_TOV'].tail(10), pts_off_tov_avg) if 'PTS_OFF_TOV' in player_df.columns else 0.0
